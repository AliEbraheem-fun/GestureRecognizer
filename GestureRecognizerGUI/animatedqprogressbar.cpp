...
AnimatedQProgressBar::AnimatedQProgressBar(QWidget *parent):QProgressBar(parent)
{
    animation=0;
...
void AnimatedQProgressBar::leaveEvent(QEvent *event)
{
    Q_UNUSED(event)
    if(animationStarted)
    {
...
void AnimatedQProgressBar::mouseMoveEvent(QMouseEvent *event)
{
    Q_UNUSED(event)
    if(!paramsSet)
    {
