...
AnimatedQComboBox::AnimatedQComboBox(QWidget *parent):QComboBox(parent)
{
    animation=0;
...
void AnimatedQComboBox::leaveEvent(QEvent *event)
{
    Q_UNUSED(event)
    if(animationStarted)
    {
...
void AnimatedQComboBox::mouseMoveEvent(QMouseEvent *event)
{
    Q_UNUSED(event)
    if(!paramsSet)
    {
