...
AnimatedQCheckBox::AnimatedQCheckBox(QWidget *parent):QCheckBox(parent)
{
    animation=0;
...
void AnimatedQCheckBox::leaveEvent(QEvent *event)
{
    Q_UNUSED(event)
    if(animationStarted)
    {
...
void AnimatedQCheckBox::mouseMoveEvent(QMouseEvent *event)
{
    Q_UNUSED(event)
    if(!paramsSet)
    {
