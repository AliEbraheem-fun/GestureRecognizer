#ifndef ANIMATEDQLISTWIDGET_H
#define ANIMATEDQLISTWIDGET_H

#include <QListWidget>
#include <QPropertyAnimation>
/*!
 * \brief The AnimatedQListWidget widgetprovides an item-based list widget.
 *
 * The AnimatedQListWidget QListWidget class and adds visual effects to its normal appearance.
 */
class AnimatedQListWidget: public QListWidget
{
    Q_OBJECT
public:

    /*!
     * Constructs an AnimatedQListWidget object.
     * \param parent The parent widget.
     */
    AnimatedQListWidget(QWidget *parent=0);
    /*!
