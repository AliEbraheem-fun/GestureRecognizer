#ifndef ANIMATEDQFRAME_H
#define ANIMATEDQFRAME_H
...
/*!
 * \brief The AnimatedQFrame class is the base class of widgets that can have a frame.
 *
 * The AnimatedQFrame class is the base class of widgets that can have a frame.
 */
class AnimatedQFrame : public QFrame
{
    Q_OBJECT
public:

    /*!
     * Constructs an AnimatedQFrame object.
     * \param parent The parent widget.
     */
    AnimatedQFrame(QWidget *parent=0);
...
private:
    ...
    QList<int> childrenOriginalWidth;/*!< The original width of the widget when it is first created. */
    QList<int> childrenOriginalHeight;/*!< The original height of the widget when it is first created. */
    QList<int> childrenOriginalX;/*!< The original x-coordinate of the widget when it is first created. */
    QList<int> childrenOriginalY;/*!< The original y-coordinate of the widget when it is first created. */

    QList<QPropertyAnimation *> childrenAnimation;
};

#endif // ANIMATEDQFRAME_H
