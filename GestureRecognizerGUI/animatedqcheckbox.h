#ifndef ANIMATEDQCHECKBOX_H
#define ANIMATEDQCHECKBOX_H

#include <QCheckBox>
#include <QPropertyAnimation>

/*!
 * \brief The AnimatedQCheckBox widget provides a text or image display..
 *
 * The AnimatedQCheckBox inherits QCheckBox class and adds visual effects to its normal appearance.
 */
class AnimatedQCheckBox:public QCheckBox
{
    Q_OBJECT
public:
    /*!
     * Constructs an AnimatedQCheckBox object.
     * \param parent The parent widget.
     */
    AnimatedQCheckBox(QWidget *parent=0);
protected:
    /*!
