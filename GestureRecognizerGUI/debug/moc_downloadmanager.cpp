...
QT_MOC_LITERAL(3, 30, 3), // "log"
QT_MOC_LITERAL(4, 34, 3), // "msg"
QT_MOC_LITERAL(5, 38, 14), // "progressStatus"
QT_MOC_LITERAL(6, 53, 13), // "bytesReceived"
QT_MOC_LITERAL(7, 67, 10), // "bytesTotal"
QT_MOC_LITERAL(8, 78, 5), // "speed"
QT_MOC_LITERAL(9, 84, 4), // "unit"
QT_MOC_LITERAL(10, 89, 17), // "progressCompleted"
QT_MOC_LITERAL(11, 107, 17), // "startNextDownload"
QT_MOC_LITERAL(12, 125, 16), // "downloadProgress"
QT_MOC_LITERAL(13, 142, 16), // "downloadFinished"
QT_MOC_LITERAL(14, 159, 17) // "downloadReadyRead"

    },
    "DownloadManager\0downloadDone\0\0log\0msg\0"
    "progressStatus\0bytesReceived\0bytesTotal\0"
    "speed\0unit\0progressCompleted\0"
...
void DownloadManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DownloadManager::log)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (DownloadManager::*_t)(qint64 , qint64 , double , QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DownloadManager::progressStatus)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (DownloadManager::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DownloadManager::progressCompleted)) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 1
void DownloadManager::log(QString _t1)
{
...
// SIGNAL 2
void DownloadManager::progressStatus(qint64 _t1, qint64 _t2, double _t3, QString _t4)
{
...
// SIGNAL 3
void DownloadManager::progressCompleted()
{
